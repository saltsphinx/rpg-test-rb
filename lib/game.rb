...
class Game
  ...
  def new_game
    ...
    apple2 = Item.new('apple', 'A bright red apple with a brown stem and a pretty green leaf atop.')
    ...
    table = ContainerObject.new([bowl, cup, apple2], 'table', 'A large, old, oval wooden table, made of dark oak.')
